...
export const ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c2-2 3-4 3-4s1 2 3 4c2-1 2.657-2.657 2.657-2.657a8 8 0 010 11.314z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.667-5.556" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.333 15.444A9.004 9.004 0 0012 21" />
  </svg>
);
